...
const Button_riding = () => (
  <div>
    <button className="cursor-pointer relative p-3 border-2 border-white overflow-hidden bg-gradient-to-tr from-yellow-100 to-yellow-200 group duration-300 hover:-rotate-45 hover:opacity-75 hover:scale-125 active:scale-100 rounded-full drop-shadow-xl">
      <svg
        className="animate-pulse group-hover:scale-100 group-hover:rotate-45 scale-75 duration-500"
      ...
      >
        <path
          ...
          d="M356.766,8.17c-20.892,0-39.481,9.814-51.446,25.071L256,96.085l-21.787,64.596l122.553-21.787  c36.098,0,65.362-29.264,65.362-65.362S392.864,8.17,356.766,8.17z M356.766,106.213h-67.171l41.434-52.796  c6.266-7.988,15.644-12.566,25.737-12.566c18.02,0,32.681,14.661,32.681,32.681S374.786,106.213,356.766,106.213z"
        ></path>
        <path
          className="fill-slate-600"
          d="M206.68,33.241C194.715,17.984,176.126,8.17,155.234,8.17c-36.098,0-65.362,29.264-65.362,65.362  s29.264,65.362,65.362,65.362L256,160.681V96.085L206.68,33.241z M155.234,106.213c-18.02,0-32.681-14.661-32.681-32.681  s14.661-32.681,32.681-32.681c10.093,0,19.471,4.577,25.73,12.557l41.441,52.805H155.234z"
        ></path>
        <polygon
          className="fill-red-400"
          points="57.191,226.043 57.191,258.723 404.033,258.723 422.128,503.83 454.809,503.83   454.809,226.043 256,171.574"
        ></polygon>
        <polygon
          className="fill-red-300"
          points="57.191,258.723 57.191,503.83 223.319,503.83 256,471.149 288.681,503.83 422.128,503.83   422.128,258.723"
        ></polygon>
        <polygon
          className="fill-red-400"
          points="433.021,138.894 411.234,171.574 433.021,226.043 465.702,226.043 465.702,138.894"
        ></polygon>
        <rect
          x="46.298"
          y="138.894"
