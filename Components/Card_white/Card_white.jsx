...
import styles from "./Card_white.module.css";

const Card_white = () => (
  <div>
    <div className={styles["popup-container"]}>
      <div className={styles["popup"] + styles["success-popup"]}>
        <div className={styles["popup-icon"] + styles["success-icon"]}>
          <svg
        ...
        <div className={styles["popup-icon"] + styles["close-icon"]}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            aria-hidden="true"
          ...
          >
            <path
              ...
              className={styles["close-path"]}
            ></path>
          </svg>
        </div>
      </div>
      <div className={styles["popup"] + styles["alert-popup"]}>
        <div className={styles["popup-icon"] + styles["alert-icon"]}>
          <svg
            className={styles["alert-svg"]}
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            aria-hidden="true"
          >
      ...
      <div className={styles["popup"] + styles["error-popup"]}>
        <div className={styles["popup-icon"] + styles["error-icon"]}>
          <svg
      ...
      <div className={styles["popup"] + styles["info-popup"]}>
        <div className={styles["popup-icon"] + styles["info-icon"]}>
          <svg
            aria-hidden="true"
            viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg"
            className={styles["info-svg"]}
          >
            <path
              clipRule="evenodd"
        ...
        <div className={styles["info-message"]}>lorem ipsum dolor sit amet</div>
        <div className={styles["popup-icon"] + styles["close-icon"]}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
