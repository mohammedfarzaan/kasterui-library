...
import styles from "./Card_clay.module.css";

const Card_clay = () => (
  <div>
    <div className={styles["card"]}>
      <p className={styles["title1"]}>#49</p>
      <p className={styles["title2"]}>creator on</p>
      <p className={styles["title2"]}>uiverse.io</p>
      <svg
...
}
{
  /*
        ...
        const Card_clay = () => (
         <div>
          <div className="card">
  <p className="title1">#49</p>
  <p className="title2">creator on</p>
  <p className="title2">uiverse.io</p>
