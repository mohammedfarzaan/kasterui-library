...
import styles from "./Card_colony.module.css";
      ...
      <div className={styles["flip-card-inner"]}>
        <div className={styles["flip-card-front"]}>
          <div className={styles["profile-image"]}>
            ...
            <div className={styles["name"]}>Ethan Johnson</div>
          </div>
        </div>
        <div className={styles["flip-card-back"]}>
          <div className={styles["Description"]}>
            <p className={styles["description"]}>
              Hello, I am a software engineer with over 5 years of experience in
              web development. I specialize in building scalable,
              high-performance web applications using modern web technologies
