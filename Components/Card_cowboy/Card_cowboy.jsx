...
import styles from "./Card_cowboy.module.css";
...
const Card_cowboy = () => (
  <div>
    <div className={styles["plan-card"]}>
      ...
      <div className={styles["etiquet-price"]}>
        <p>254.99</p>
        <div></div>
      </div>
      ...
      <div className={styles["button-get-plan"]}>
        <a href="#">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            className={styles["svg-rocket"]}
          >
