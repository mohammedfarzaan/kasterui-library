...
const Card_answer = () => (
  <div>
    <div className="card h-72 relative border-2 border-blue-600 bg-gradient-to-b from-blue-600 from-[12%] via-[12%] via-white to-70% to-white shadow-lg shadow-lg rounded-xl w-72 flex justify-center items-center text-white">
      ...
      <p className="text-black">WINDOWS XP TIMES</p>
    </div>
  </div>
);
