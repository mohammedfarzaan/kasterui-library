...
import styles from "./Toggle_eaten.module.css";
...
const Toggle_eaten = () => (
  <div>
    <div className={styles["btn-container"]}>
      <svg
        viewBox="0 0 16 16"
        className={styles["bi"] + styles["bi-sun-fill"]}
        fill="currentColor"
        width="23"
      ...
      <svg
        viewBox="0 0 16 16"
        className={styles["bi"] + styles["bi-moon-stars-fill"]}
        fill="currentColor"
        width="23"
        xmlns="http://www.w3.org/2000/svg"
      >
