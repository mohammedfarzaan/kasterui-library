...
import styles from "./Card_speak.module.css";
  ...
  <div>
    <div
      className={
        ...
        styles["rounded-xl"] +
        styles["border"] +
        styles["border-[rgba(255,255,255,0.10)]"] +
        styles["dark:bg-[rgba(40,40,40,0.70)]"] +
        styles["bg-gray-100"] +
        styles["shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset]"] +
        styles["group"]
      }
    >
      <div
        ...
        >
          ...
          >
            <div
              className={
                ...
                styles["items-center"] +
                styles["justify-center"] +
                styles["bg-[rgba(248,248,248,0.01)]"] +
                styles[
            ...
            >
              <svg
                ...
                clipRule="evenodd"
                viewBox="0 0 512 512"
                className={styles["h-4"] + styles["w-4"]}
              >
                <rect
                  fill="#CC9B7A"
                  width="512"
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                className={
                  styles["h-6"] + styles["w-6"] + styles["dark:text-white"]
                }
                height="1em"
                width="1em"
                xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <svg
                className={
                  styles["h-8"] + styles["w-8"] + styles["dark:text-white"]
                }
                width="28"
                viewBox="0 0 28 28"
                fill="none"
          ...
          <div
            className={
              ...
              styles["m-auto"] +
              styles["z-40"] +
              styles["bg-gradient-to-b"] +
              styles["from-transparent"] +
              styles["via-cyan-500"] +
              styles["to-transparent"] +
              styles["animate-move"]
            }
          >
            <div
            ...
            >
              <div className={styles["absolute"] + styles["inset-0"]}>
                <span
                  className={
                    styles["inline-block"] +
                    styles["bg-black"] +
                    styles["dark:bg-white"] +
                    styles["style-85zWm"]
                  }
                  id="style-85zWm"
                ></span>
...
>
  <div
    className="h-[15rem] md:h-[20rem] rounded-xl z-40 bg-neutral-300 dark:bg-[rgba(40,40,40,0.70)] [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]"
  >
    <div
