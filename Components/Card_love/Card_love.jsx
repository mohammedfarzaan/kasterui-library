    ...
    <div className="bg-white rounded-lg shadow-lg p-6 max-w-xs font-serif">
      <div className="relative">
        <svg
          fill="currentColor"
          viewBox="0 0 24 24"
          className="absolute -top-6 -right-6 w-24 h-24 text-indigo-400 opacity-25"
        >
          <path d="M12 0l3.094 9.488h9.956L15.49 15.338 18.585 24 12 18.512 5.415 24l3.094-8.662L0 9.488h9.956z"></path>
        </svg>
        <svg
          fill="currentColor"
          viewBox="0 0 24 24"
