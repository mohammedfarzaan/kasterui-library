...
import styles from "./Card_verb.module.css";
...
}
{
  /*
        ...
        const Card_verb = () => (
         <div>
          <div className="card">
    <div className="logo"><svg className="svg" viewBox="0 0 94 94" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="icons-container">
        <svg strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className="svg">
            <rect ry="5" rx="5" y="2" x="2" height="20" width="20"></rect>
            <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path>
            <line y2="6.5" y1="6.5" x2="17.51" x1="17.5"></line>
        </svg>
        <svg viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg" className="svg twitter">
            <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"></path>
        </svg>
        <svg strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className="svg">
            <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path>
    ...
    <div className="box box3">
        <div className="content">
            <span className="box-title">Title 1</span>
            <span className="box-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus, facere.
            </span>
    ...
    <div className="box box2">
        <div className="content">
            <span className="box-title">Title 2</span>
            <span className="box-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Et hic praesentium
    ...
    <div className="box box1">
        <div className="content">
            <span className="box-title">Title 3</span>
            <span className="box-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea, facilis!
            </span>
        </div>
    </div>
</div>
