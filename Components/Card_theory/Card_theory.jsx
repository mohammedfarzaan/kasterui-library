...
import styles from "./Card_theory.module.css";
      ...
      <div className={styles["bottom-section"]}>
        ...
        <div className={styles["row"] + styles["row1"]}>
          <div className={styles["item"]}>
            <span className={styles["big-text"]}>2626</span>
            <span className={styles["regular-text"]}>UI elements</span>
          </div>
          <div className={styles["item"]}>
            <span className={styles["big-text"]}>100%</span>
            <span className={styles["regular-text"]}>Free for use</span>
          </div>
          <div className={styles["item"]}>
            <span className={styles["big-text"]}>38,631</span>
            <span className={styles["regular-text"]}>Contributers</span>
          </div>
        </div>
      </div>
    </div>
