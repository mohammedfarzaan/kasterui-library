...
import styles from "./Card_tiny.module.css";
      ...
      <div className={styles["card-header"]}>
        <div className={styles["card-header-bar"]}>
          <a className={styles["btn-message"]} href="#">
            <svg
              viewBox="0 0 16 16"
              className={styles["bi"] + styles["bi-chat-dots-fill"]}
              fill="white"
              height="16"
              width="16"
...
}
{
  ...
  <path d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z" fillRule="evenodd"></path>
      ...
      <div className="card-body">
          <span className="name">John Smith</span><br />
