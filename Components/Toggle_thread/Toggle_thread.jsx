...
import styles from "./Toggle_thread.module.css";
    ...
    <div className={styles["container"]}>
      <label className={styles["switch"]}>
        ...
        <svg
          ...
          width="12px"
          viewBox="0 0 12 12"
          className={styles["switch__icon"] + styles["switch__icon--light"]}
        >
        ...
        <svg
          ...
          width="12px"
          viewBox="0 0 12 12"
          className={styles["switch__icon"] + styles["switch__icon--dark"]}
        >
          <g
            transform="rotate(-45,6,6)"
