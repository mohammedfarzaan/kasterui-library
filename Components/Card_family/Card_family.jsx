...
import styles from "./Card_family.module.css";

const Card_family = () => (
  <div>
    <div className={styles["card"]}>
      <div className={styles["gradient"]}></div>
      <p className={styles["title"]}>uiverse</p>
      <p className={styles["label"]}>
        ui/ux designer trying to be an fullstack devolper
        <br />
        mom i love u
      </p>
