...
const Card_taught = () => (
  <div>
    <div className="card relative flex h-[10em] w-[15em] items-start justify-center overflow-clip rounded-[1.5em] bg-[#B7DFFB] px-[1em] py-[1.5em] shadow-[0px_2px_2px_0px_#1a4766,0px_2px_8px_0px_#3083bb]">
      <span className="max-w-[20ch] text-center font-Poppin text-[1em] font-bold text-[#085991]">
      ...
      <div className="group absolute bottom-[-1em] left-[2.5em] flex max-h-[6em] w-[10em] items-center justify-center gap-[11rem]">
        <label for="yes" className="yes peer relative cursor-pointer">
          <input
            type="checkbox"
            name="yes"
            id="yes"
