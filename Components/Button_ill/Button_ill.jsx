...
import styles from "./Button_ill.module.css";
        ...
        >
          ...
          <g id="c">
            ...
            <g>
              ...
              ></path>
              <path
                style="fill:url(#ax); filter:url(#ay); stroke:#2b2b2b; stroke-miterlimit:10; strokeWidth:2px;"
              ...
              ></path>
              <line
                style="fill:none; stroke:#2b2b2b; stroke-miterlimit:10; strokeWidth:.75px;"
                y2="426.74"
                x2="126.39"
                y1="448.76"
                x1="183.2"
              ...
              ></path>
              <path
                style="fill:none; stroke:#777574; stroke-miterlimit:10; strokeWidth:.75px;"
              ...
              >
                ...
                <tspan style="letter-spacing:-.01em;" y="0" x="14.3">
                  n
                </tspan>
                <tspan style="letter-spacing:0em;" y="0" x="17.4">
                  y
                </tspan>
                <tspan style="letter-spacing:0em;" y="0" x="20.09">
                  otsu
                </tspan>
              </text>
              <text
              ...
              ></path>
              <line
                style="fill:#fff; stroke:#2b2b2b; stroke-miterlimit:10; strokeWidth:.5px;"
                y2="426.74"
                x2="126.39"
                y1="432.01"
                x1="124.42"
