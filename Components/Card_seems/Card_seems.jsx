...
import styles from "./Card_seems.module.css";
    ...
    <div className={styles["modal"]}>
      <article className={styles["modal-container"]}>
        <header className={styles["modal-container-header"]}>
          <span className={styles["modal-container-title"]}>
            <svg
              aria-hidden="true"
              height="24"
              width="24"
        ...
        <footer className={styles["modal-container-footer"]}>
          <button className={styles["button"] + styles["is-ghost"]}>
            Decline
          </button>
          <button className={styles["button"] + styles["is-primary"]}>
            Accept
          </button>
        </footer>
      </article>
