...
import styles from "./Card_heavy.module.css";
  ...
  <div>
    <div className={styles["card"]}>
      <p className={styles["time-text"]}>
        <span>11:11</span>
        <span className={styles["time-sub-text"]}>PM</span>
      </p>
      <p className={styles["day-text"]}>Wednesday, June 15th</p>
      <svg
