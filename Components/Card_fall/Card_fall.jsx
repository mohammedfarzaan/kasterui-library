...
import styles from "./Card_fall.module.css";
...
const Card_fall = () => (
  <div>
    <div className={styles["social-card"]}>
      ...
      <button className={styles["Btn"] + styles["whatsapp"]}>
        <span className={styles["svgContainer"]}>
          <svg
      ...
      <button className={styles["Btn"] + styles["linkdin"]}>
        <span className={styles["svgContainer"]}>
          <svg
            fill="white"
      ...
      <button className={styles["Btn"] + styles["discord"]}>
        <span className={styles["svgContainer"]}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="1.4em"
