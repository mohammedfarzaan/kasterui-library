...
const Button_cave = () => (
  <div>
    <button className={styles["crushbtn"]}>
      crush
...
}
{
  /*
        ...
        const Button_cave = () => (
         <div>
          <button className="crushbtn">
    crush
    <div className="heart1">

        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="">
