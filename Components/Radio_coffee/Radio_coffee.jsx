...
import styles from "./Radio_coffee.module.css";
      ...
      <div className={styles["radio-tile-group"]}>
        <div className={styles["input-container"]}>
          <input
            ...
            name="radio"
          />
          <div className={styles["radio-tile"]}>
            <div className={styles["icon"] + styles["walk-icon"]}>
              <svg
                fill="#000000"
                height="24"
                viewBox="0 0 24 24"
            ...
            <label for="walk" className={styles["radio-tile-label"]}>
              Walk
            </label>
          </div>
        </div>
        ...
        <div className={styles["input-container"]}>
          ...
          />
          <div className={styles["radio-tile"]}>
            <div className={styles["icon"] + styles["bike-icon"]}>
              <svg
                fill="#000000"
                height="24"
                viewBox="0 0 24 24"
            ...
            <label for="bike" className={styles["radio-tile-label"]}>
              Bike
            </label>
          </div>
        </div>
        ...
        <div className={styles["input-container"]}>
          ...
          />
          <div className={styles["radio-tile"]}>
            <div className={styles["icon"] + styles["car-icon"]}>
              <svg
                fill="#000000"
                height="24"
                viewBox="0 0 24 24"
            ...
            <label for="drive" className={styles["radio-tile-label"]}>
              Drive
            </label>
          </div>
        </div>
  ...
  <div className="radio-tile-group">
    <div className="input-container">
      ...
      <div className="radio-tile">
        ...
        <label for="walk" className="radio-tile-label">Walk</label>
      </div>
    </div>
    ...
    <div className="input-container">
      ...
      <div className="radio-tile">
        ...
        <label for="bike" className="radio-tile-label">Bike</label>
      </div>
    </div>
    ...
    <div className="input-container">
      ...
      <div className="radio-tile">
        ...
        <label for="drive" className="radio-tile-label">Drive</label>
      </div>
    </div>
  </div>
</div>
