...
import styles from "./Card_group.module.css";
      ...
      <div className={styles["phone"]}>
        <div className={styles["face"] + styles["front"]}>
          <div className={styles["head"]}>
            <div className={styles["h-left"]}>moov</div>
          ...
          <div className={styles["search"]}>
            <input
              placeholder="Search..."
              type="search"
              className={styles["search-google"]}
            />
            <svg
              width="24"
              viewBox="0 0 24 24"
          ...
          <div className={styles["date"]}>
            <span className={styles["hour"]}>10:50</span>
            <span className={styles["period"]}>PM</span>
            <br />
            <span className={styles["day"]}>Sat, 04 Nov</span>
          </div>
          ...
          <div className={styles["home"]}>
            ...
            <span className={styles["app"] + styles["full-logo"]}>
              <svg
                className={styles["logo-app"]}
                clipRule="evenodd"
                fillRule="evenodd"
          ...
          <div className={styles["home"] + styles["home2"]}>
            <span className={styles["app"]}></span>
            <span className={styles["app"] + styles["logo-phone"]}>
              <svg
                xml:space="preserve"
            ...
            <span className={styles["app"] + styles["menu"]}>
              <svg
                className={styles["logo-menu"]}
                version="1.1"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <span className={styles["app"] + styles["message"]}>
              <svg
                xml:space="preserve"
          ...
          <div className={styles["navigation"]}>
            <span className={styles["btn"] + styles["btn-task"]}></span>
            <span className={styles["btn"] + styles["btn-home"]}></span>
            <span className={styles["btn"] + styles["btn-back"]}></span>
          </div>
          <div className={styles["front-camera"]}></div>
        </div>
        ...
        <div className={styles["face"] + styles["bottom"]}>
          <div className={styles["elements"]}>
            ...
            <span className={styles["charge"]}></span>
