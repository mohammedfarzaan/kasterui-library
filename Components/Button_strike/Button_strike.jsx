...
import styles from "./Button_strike.module.css";
    ...
    <ul className={styles["wrapper"]}>
      <li className={styles["icon"] + styles["black"]}>
        ...
        <span>
          <svg
            viewBox="0 0 16 16"
            className={styles["bi"] + styles["bi-chevron-double-up"]}
            fill="currentColor"
            height="16"
            width="16"
      ...
      <li className={styles["icon"] + styles["black"]}>
        ...
        <span>
          <svg
            viewBox="0 0 16 16"
            className={styles["bi"] + styles["bi-chevron-double-down"]}
            fill="currentColor"
            height="16"
            width="16"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li className={styles["icon"] + styles["black"]}>
        ...
        <span>
          <svg
            viewBox="0 0 16 16"
            className={styles["bi"] + styles["bi-chevron-double-left"]}
            fill="currentColor"
            height="16"
            width="16"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li className={styles["icon"] + styles["black"]}>
        ...
        <span>
          <svg
            viewBox="0 0 16 16"
            className={styles["bi"] + styles["bi-chevron-double-right"]}
            fill="currentColor"
            height="16"
            width="16"
            xmlns="http://www.w3.org/2000/svg"
