...
import styles from "./Card_slight.module.css";
...
const Card_slight = () => (
  <div>
    <div className={styles["error"]}>
      ...
      <div className={styles["error__title"]}>lorem ipsum dolor sit amet</div>
      <div className={styles["error__close"]}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          viewBox="0 0 20 20"
