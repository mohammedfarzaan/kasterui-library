...
import styles from "./Card_sense.module.css";

const Card_sense = () => (
  <div>
    <div className={styles["main"]}>
      <div className={styles["card"]}>
        <div className={styles["heading"]}>UltraFlex</div>
...
<svg className="glasses" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100px" height="100px" viewBox="0 0 100 100" xml:space="preserve">  <image id="image0" width="100" height="100" x="0" y="0" href="data:image/png;base64,
