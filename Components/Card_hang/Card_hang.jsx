...
import styles from "./Card_hang.module.css";
  ...
  <div>
    <div className={styles["card"]}>
      ...
      <div className={styles["message-text-container"]}>
        <p className={styles["message-text"]}>Success message</p>
        <p className={styles["sub-text"]}>Everything seems great</p>
      </div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 15 15"
