...
import styles from "./Toggle_flow.module.css";

const Toggle_flow = () => (
  <div>
    <input type="checkbox" id="checkbox" />
    <label className={styles["switch"]} for="checkbox">
      <div className={styles["mic-on"]}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
          fill="currentColor"
          className={styles["bi"] + styles["bi-mic-fill"]}
          viewBox="0 0 16 16"
        >
          {" "}
      ...
      <div className={styles["mic-off"]}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
          fill="currentColor"
          className={styles["bi"] + styles["bi-mic-mute-fill"]}
          viewBox="0 0 16 16"
        >
          {" "}
