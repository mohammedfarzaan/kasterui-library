...
import styles from "./Card_father.module.css";
  ...
  <div>
    <div className={styles["card"]}>
      <div className={styles["image-container"]}>
        ...
        >
          ...
          <g transform="translate(-121.5 -92.5)" id="hoodie">
            ...
            <g
              transform="translate(1048.135 448.054)"
              data-name="Group 75"
              id="Group_75"
            >
              <g transform="translate(0 0)" data-name="Group 73" id="Group_73">
                <path
                  fill="#47474c"
                  transform="translate(-936.484 -395.41)"
                  d="M947.836,401.358a5.418,5.418,0,1,1-5.418-5.418A5.414,5.414,0,0,1,947.836,401.358Z"
                  data-name="Path 39"
                  id="Path_39"
                ></path>
                <path
                  transform="translate(-936.64 -395.57)"
                  d="M942.574,407.438a5.934,5.934,0,1,1,5.934-5.934A5.946,5.946,0,0,1,942.574,407.438Zm0-10.822a4.9,4.9,0,1,0,4.9,4.9A4.909,4.909,0,0,0,942.574,396.616Z"
                  data-name="Path 40"
                  id="Path_40"
                ></path>
              </g>
              <g
                transform="translate(56.487 0)"
                data-name="Group 74"
                id="Group_74"
              >
                <path
                  fill="#47474c"
                  transform="translate(-975.894 -395.41)"
                  d="M987.246,401.358a5.418,5.418,0,1,1-5.418-5.418A5.414,5.414,0,0,1,987.246,401.358Z"
                  data-name="Path 41"
                  id="Path_41"
                ></path>
                <path
                  transform="translate(-976.05 -395.57)"
                  d="M981.984,407.438a5.934,5.934,0,1,1,5.934-5.934A5.946,5.946,0,0,1,981.984,407.438Zm0-10.822a4.9,4.9,0,1,0,4.9,4.9A4.909,4.909,0,0,0,981.984,396.616Z"
                  data-name="Path 42"
                  id="Path_42"
                ></path>
              </g>
            ...
            <path
              transform="translate(136.632 21.684)"
              d="M1110.076,324.49c-1.089,6.163,3.626,6.034,3.626,6.034-4.071,4.8-19.966,19.909-25.14,23.464a98.7,98.7,0,0,1-16.526,9c-5.719,2.494-11.395,4.73-17.013,7.281A249.431,249.431,0,0,0,1022.356,387a118.945,118.945,0,0,0-27.706,23.965,94.137,94.137,0,0,1,11.61-14.563,113.846,113.846,0,0,1,14.333-12.04c10.191-7.281,21.442-12.814,32.766-17.874,11.409-5.06,23.12-8.786,33.468-15.15C1098.81,343.811,1108.1,330.352,1110.076,324.49Z"
              data-name="Path 43"
              id="Path_43"
            ></path>
            <path
              transform="translate(71.035 21.35)"
              d="M952.36,396.791a122.341,122.341,0,0,0-14.376-11.567,193.593,193.593,0,0,0-32.006-18.046c-47.371-21.013-56.014-34.514-59.483-43.458,0,0,.86,5.576-3.225,7.124a84.15,84.15,0,0,0,28.193,23.564c10.664,6.178,21.815,11.137,32.723,16.469,10.951,5.246,21.772,10.707,32.092,16.956,10.22,6.35,20.081,13.588,27.348,23.449A62.461,62.461,0,0,0,952.36,396.791Z"
              data-name="Path 44"
              id="Path_44"
            ></path>
            <g
              transform="translate(949.178 540.102)"
              data-name="Group 76"
              id="Group_76"
            >
              <path
                fill="#dbdbdb"
                transform="translate(-799.273 -418.369)"
                d="M1065.571,570.358h-11.682a7.9,7.9,0,0,0-1.691-4.071c-1.247-1.247-3.383-1.892-6.321-1.892-2.9,0-4.916.487-6.034,1.448a3.767,3.767,0,0,0-1.29,2.981c0,1.763,2.465,3.182,7.324,4.271a114.856,114.856,0,0,1,12,3.1c.645.244,1.2.444,1.605.645,4.959,2.336,7.41,5.891,7.41,10.635,0,5.8-2.422,10.033-7.21,12.685-.6.33-1.175.6-1.82.889a27.2,27.2,0,0,1-10.793,2.007c-6.077,0-10.994-1.089-14.735-3.225a14.084,14.084,0,0,1-5.289-5.16,14.53,14.53,0,0,1-1.763-7.281h12.241a5.831,5.831,0,0,0,2.25,4.873c1.491,1.175,4.028,1.777,7.611,1.777,2.695,0,4.716-.573,6.049-1.691a3.78,3.78,0,0,0,1.534-2.981c0-1.892-2.408-3.383-7.21-4.429-7.167-1.534-11.682-2.781-13.531-3.669-4.916-2.293-7.324-5.834-7.324-10.75a14.031,14.031,0,0,1,3.827-10.019c3.225-3.426,8.055-5.117,14.462-5.117,5.275,0,9.5.774,12.685,2.25a4.393,4.393,0,0,1,.774.4,12.756,12.756,0,0,1,5.189,4.959A14.855,14.855,0,0,1,1065.571,570.358Z"
                data-name="Path 45"
                id="Path_45"
              ></path>
              <path
                fill="#dbdbdb"
                transform="translate(-830.846 -459.79)"
                d="M1027.956,520.592l33.067,55.1H1007.9l-31.576-52.632L952.42,483.225l23.908-14.376,15.064-9.059Z"
                data-name="Path 46"
                id="Path_46"
              ></path>
              <path
                fill="#dbdbdb"
                transform="translate(-815.203 -418.213)"
                d="M1036.321,579.662v22.589h-10.994v-2.494a23.509,23.509,0,0,1-12.886,3.827h-.129a23.923,23.923,0,0,1,0-47.844h.129a23.627,23.627,0,0,1,12.886,3.827v-2.623h10.994Zm-10.994,2.494v-4.988a13.186,13.186,0,0,0-12.886-10.635h-.129a13.151,13.151,0,0,0,0,26.3h.129A13.25,13.25,0,0,0,1025.328,582.156Z"
                data-name="Path 47"
                id="Path_47"
              ></path>
              <path
                fill="#dbdbdb"
                transform="translate(-830.807 -422.546)"
                d="M1000.3,584v22.589H989.3v-2.494a23.58,23.58,0,0,1-12.885,3.827H976.3a23.923,23.923,0,0,1,0-47.844h.115A23.663,23.663,0,0,1,989.3,563.9V545.74H1000.3ZM989.3,586.489V581.5a13.186,13.186,0,0,0-12.885-10.635H976.3a13.151,13.151,0,0,0,0,26.3h.115A13.238,13.238,0,0,0,989.3,586.489Z"
                data-name="Path 48"
                id="Path_48"
              ></path>
              <path
                fill="#dbdbdb"
                transform="translate(-845.041 -447.323)"
                d="M990.524,541.55l12.972,21.672H950.419L920.95,514.173l-1.29-2.136,1.29-.76,37.725-22.718Z"
                data-name="Path 49"
                id="Path_49"
              ></path>
              <rect
                fill="#dbdbdb"
                transform="translate(105.421 137.527)"
                height="46.511"
                width="11.954"
              ...
              <rect
                fill="#dbdbdb"
                transform="translate(105.421 123.438)"
                height="10.506"
                width="11.954"
              ...
              <path
                fill="#dbdbdb"
                transform="translate(-851.844 -422.546)"
                d="M951.79,584v22.589H940.8v-2.494a23.688,23.688,0,0,1-12.929,3.827h-.115a23.923,23.923,0,0,1,0-47.844h.115A23.808,23.808,0,0,1,940.8,563.9V545.74H951.79ZM940.8,586.489V581.5a13.185,13.185,0,0,0-12.929-10.635h-.115a13.151,13.151,0,0,0,0,26.3h.115A13.237,13.237,0,0,0,940.8,586.489Z"
                data-name="Path 50"
                id="Path_50"
              ></path>
              <path
                fill="#dbdbdb"
                transform="translate(-859.224 -434.844)"
                d="M935.133,532.611,946,550.742h-53.1l-5.963-9.947,39.015-23.435Z"
                data-name="Path 51"
                id="Path_51"
              ></path>
              <path
                fill="#dbdbdb"
                transform="translate(-867.6 -418.213)"
                d="M915.4,579.662v22.589H904.408v-2.494a23.724,23.724,0,0,1-12.929,3.827h-.129a23.923,23.923,0,0,1,0-47.844h.129a23.881,23.881,0,0,1,12.929,3.827v-2.623H915.4Zm-10.994,2.494v-4.988a13.186,13.186,0,0,0-12.929-10.635h-.129a13.152,13.152,0,0,0,0,26.3h.129A13.25,13.25,0,0,0,904.408,582.156Z"
                data-name="Path 52"
                id="Path_52"
              ></path>
            </g>
            <path
              transform="translate(111.117 53.658)"
              d="M942.952,521.374a2.056,2.056,0,0,1-2.021-1.691c-11.567-63.439-.1-119.21.014-119.769a2.065,2.065,0,0,1,4.042.846c-.115.545-11.4,55.57.014,118.178a2.086,2.086,0,0,1-1.663,2.408A3.533,3.533,0,0,1,942.952,521.374Z"
              data-name="Path 53"
              id="Path_53"
            ></path>
            <path
              transform="translate(128.257 53.656)"
              d="M977.4,540.182a1.749,1.749,0,0,1-.53-.072,2.068,2.068,0,0,1-1.476-2.523c12.212-46.368,4.916-136.18,4.845-137.083a2.063,2.063,0,0,1,4.114-.33c.072.9,7.425,91.417-4.959,138.473A2.065,2.065,0,0,1,977.4,540.182Z"
              data-name="Path 54"
              id="Path_54"
            ></path>
            <path
              transform="translate(111.144 85.257)"
              d="M946.666,476.618a5.418,5.418,0,1,1-5.418-5.418A5.414,5.414,0,0,1,946.666,476.618Z"
              data-name="Path 55"
              id="Path_55"
            ></path>
            <path
              transform="translate(127.991 91.15)"
              d="M985.546,490.218a5.418,5.418,0,1,1-5.418-5.418A5.414,5.414,0,0,1,985.546,490.218Z"
              data-name="Path 56"
              id="Path_56"
            ></path>
            <path
              transform="translate(57.485 54.278)"
              d="M812,399.71c4.2,19.694,6.436,39.818,8.887,59.813,2.322,20.038,4.142,40.133,5.69,60.243,1.39,20.124,2.523,40.276,2.981,60.443.487,20.167.358,40.362-.731,60.5.315-20.167-.1-40.319-.86-60.443q-1.182-30.207-3.454-60.343c-1.39-20.1-3.225-40.176-5.217-60.228q-1.484-15.05-3.225-30.057C814.867,419.648,814.007,409.557,812,399.71Z"
              data-name="Path 57"
              id="Path_57"
            ></path>
            <path
              transform="translate(180.783 54.278)"
              d="M1114.371,399.71c-2.021,9.833-2.881,19.938-4.085,29.928q-1.741,15.007-3.225,30.057c-1.978,20.052-3.827,40.119-5.217,60.228q-2.322,30.143-3.454,60.343c-.76,20.138-1.175,40.291-.86,60.443-1.075-20.138-1.2-40.334-.731-60.5s1.591-40.319,2.981-60.443c1.562-20.11,3.368-40.2,5.69-60.243C1107.936,439.528,1110.172,419.418,1114.371,399.71Z"
              data-name="Path 58"
              id="Path_58"
            ></path>
          </g>
      ...
      <div className={styles["content"]}>
        ...
        <div className={styles["product-name"]}>Classic oversized hoodie</div>
        <div className={styles["color-size-container"]}>
          <div className={styles["colors"]}>
            Color
            <ul className={styles["colors-container"]}>
              <li className={styles["color"]}>
                <a href="#"></a>{" "}
                <span className={styles["color-name"]}>Collegiate Gold</span>
              </li>
              <li className={styles["color"] + styles["active"]}>
                <a href="#"></a>
                <span className={styles["color-name"]}>Team Navy</span>
              </li>
              <li className={styles["color"]}>
                <a href="#"></a>
                <span className={styles["color-name"]}>Pulse Blue</span>
              </li>
              <li className={styles["color"]}>
                <a href="#"></a>
                <span className={styles["color-name"]}>Pink Fusion</span>
              </li>
              +2
            </ul>
          </div>
          <div className={styles["sizes"]}>
            Size
            <ul className={styles["size-container"]}>
              <li className={styles["size"]}>
                <label className={styles["size-radio"]}>
                  <input name="size" value="xs" type="radio" />
                  <span className={styles["name"]}>XS</span>
                </label>
              </li>
              <li className={styles["size"]}>
                <label className={styles["size-radio"]}>
              ...
              <li className={styles["size"]}>
                <label className={styles["size-radio"]}>
                  ...
                  <span className={styles["name"]}>L</span>
                </label>
              </li>
              <li className={styles["size"]}>
                <label className={styles["size-radio"]}>
                  <input name="size" value="xl" type="radio" />
                  <span className={styles["name"]}>XL</span>
                </label>
              </li>
            </ul>
          </div>
        ...
        <div className={styles["rating"]}>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            className={styles["svg"] + styles["four-star-svg"]}
          >
            <path
              fill="#fc0"
      ...
      <div className={styles["button-container"]}>
        <button className={styles["buy-button"] + styles["button"]}>
          Buy Now
        </button>
        <button className={styles["cart-button"] + styles["button"]}>
    ...
    <div className="image-container">
            <svg viewBox="0 0 1921 1081" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" className="svg">
                <defs>
                    ...
                    <g transform="translate(-121.5 -92.5)" id="hoodie">
                    <rect fill="url(#radial-gradient)" strokeWidth="1" stroke-miterlimit="10" stroke="#fff" transform="translate(122 93)" height="1080" width="1920" data-name="Rectangle 83" id="Rectangle_83"></rect>
