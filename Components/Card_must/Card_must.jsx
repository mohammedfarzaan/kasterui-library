...
import styles from "./Card_must.module.css";

const Card_must = () => (
  <div>
    <div className={styles["task"]} draggable="true">
      <div className={styles["tags"]}>
        <span className={styles["tag"]}>Draggable</span>
...
}
{
  ...
  <div className="stats">
    <div>
      <div><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><g strokeWidth="0" id="SVGRepo_bgCarrier"></g><g strokeLinejoin="round" strokeLinecap="round" id="SVGRepo_tracerCarrier"></g><g id="SVGRepo_iconCarrier"> <path strokeLinecap="round" strokeWidth="2" d="M12 8V12L15 15"></path> <circle strokeWidth="2" r="9" cy="12" cx="12"></circle> </g></svg>Feb 24</div>
