...
import styles from "./Card_rocket.module.css";

const Card_rocket = () => (
  <div>
    <div className={styles["rating-card"]}>
      <div className={styles["text-wrapper"]}>
        <p className={styles["text-primary"]}>Please Rate Your Experience</p>
        <p className={styles["text-secondary"]}>to help us serve you better</p>
      </div>

      <div className={styles["rating-stars-container"]}>
        <input value="star-5" name="star" id="star-5" type="radio" />
        <label for="star-5" className={styles["star-label"]}>
        ...
        <label for="star-4" className={styles["star-label"]}>
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z"
              pathLength="360"
        ...
        <label for="star-3" className={styles["star-label"]}>
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z"
              pathLength="360"
        ...
        <label for="star-2" className={styles["star-label"]}>
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z"
              pathLength="360"
        ...
        <label for="star-1" className={styles["star-label"]}>
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z"
              pathLength="360"
