...
import styles from "./Radio_tales.module.css";
...
const Radio_tales = () => (
  <div>
    <div className={styles["radio-inputs"]}>
      <label>
        <input
          className={styles["radio-input"] + styles["instagram"]}
          type="radio"
          name="engine"
        />
        <span className={styles["radio-tile"] + styles["instagram"]}>
      ...
      <label>
        <input
          className={styles["radio-input"] + styles["twitter"]}
          type="radio"
          name="engine"
        />
        <span className={styles["radio-tile"] + styles["twitter"]}>
          <span className={styles["radio-icon"]}>
            <svg
      ...
      <label>
        <input
          className={styles["radio-input"] + styles["discord"]}
          type="radio"
          name="engine"
        />
        <span className={styles["radio-tile"] + styles["discord"]}>
          <span className={styles["radio-icon"]}>
            <svg
