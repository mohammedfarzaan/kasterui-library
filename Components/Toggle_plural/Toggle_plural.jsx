...
import styles from "./Toggle_plural.module.css";

const Toggle_plural = () => (
  <div>
    <div>
      <label className={styles["switch"]} for="switch">
        <input id="switch" type="checkbox" className={styles["circle"]} />
        <svg
          viewBox="0 0 384 512"
