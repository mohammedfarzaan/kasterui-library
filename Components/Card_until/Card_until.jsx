...
import styles from "./Card_until.module.css";
  ...
  <div>
    <div className={styles["card"]}>
      ...
      <div className={styles["textContainer"]}>
        <p className={styles["name"]}>Pepper Potts</p>
