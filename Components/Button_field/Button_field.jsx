...
const Button_field = () => (
  <div>
    <button className={styles["Btn"]}>
      <svg className={styles["Layer"]} viewBox="0 0 1095.66 1095.63">
        <path
      ...
      <p className={styles["text"]}>Hover Me</p>
    </button>
  </div>
);
