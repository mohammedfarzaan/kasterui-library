...
const Button_hair = () => (
  <div>
    <div className={styles["parent"]}>
      <div className={styles["child"] + styles["child-1"]}>
        <button className={styles["button"] + styles["btn-1"]}>
          <svg
      ...
      <div className={styles["child"] + styles["child-2"]}>
      ...
      <div className={styles["child"] + styles["child-3"]}>
        <button className={styles["button"] + styles["btn-3"]}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="1em"
            viewBox="0 0 496 512"
      ...
      <div className={styles["child"] + styles["child-4"]}>
        <button className={styles["button"] + styles["btn-4"]}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="1em"
            viewBox="0 0 320 512"
