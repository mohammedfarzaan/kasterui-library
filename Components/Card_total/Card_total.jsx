...
import styles from "./Card_total.module.css";
...
const Card_total = () => (
  <div>
    <div className={styles["card"]}>
      ...
      <div className={styles["card__avatar"]}>
        <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
          ...
          <g fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path d="m64 67v4" stroke="#fbc0aa" strokeWidth="4"></path>
            <path
              d="m55 56h-9.25"
              opacity=".2"
              stroke="#515570"
      ...
      <div className={styles["card__title"]}>Cameron Williamson</div>
      <div className={styles["card__subtitle"]}>Web Development</div>
      <div className={styles["card__wrapper"]}>
        <button className={styles["card__btn"]}>Button</button>
        <button className={styles["card__btn"] + styles["card__btn-solid"]}>
          Button
        </button>
      </div>
    </div>
