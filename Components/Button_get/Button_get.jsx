...
const Button_get = () => (
  <div>
    <button className="group relative w-28 h-12 text-neutral-50 bg-neutral-800 p-2 overflow-hidden">
      <p className="absolute  font-bold z-10  duration-500"> Button</p>
      <div class="">
