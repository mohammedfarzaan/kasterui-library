...
import styles from "./Button_useful.module.css";
  ...
  <div>
    <button
      ...
      className={
        ...
        styles["text-center"] +
        styles["mr-2"] +
        styles["dark:bg-blue-600"] +
        styles["dark:hover:bg-blue-700"] +
        styles["dark:focus:ring-blue-800"] +
        styles["inline-flex"] +
        styles["items-center"]
      }
    >
