...
import styles from "./Card_cannot.module.css";
    ...
    <div className={styles["card"] + styles["work"]}>
      ...
      <div className={styles["card-desc"]}>
        <div className={styles["card-header"]}>
          <div className={styles["card-title"]}>Play</div>
        ...
        <div className={styles["card-time"]}>32hrs</div>
        <p className={styles["recent"]}>Last Week-36hrs</p>
      </div>
    </div>
  </div>
);

export default Card_cannot;
{
