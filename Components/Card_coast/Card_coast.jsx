...
import styles from "./Card_coast.module.css";
  ...
  <div>
    <div className={styles["card"]}>
      <div className={styles["card-info"]}>
        ...
        <div className={styles["card-title"]}>Steve Jobs</div>
        <div className={styles["card-subtitle"]}>CEO &amp; Co-Founder</div>
      </div>
      <ul className={styles["card-social"]}>
