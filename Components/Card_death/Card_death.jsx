...
import styles from "./Card_death.module.css";
  ...
  <div>
    <div className={styles["card"]}>
      <div className={styles["item"] + styles["item--1"]}>
        ...
        <span className={styles["quantity"]}> 90+ </span>
        <span className={styles["text"] + styles["text--1"]}> Icons </span>
      </div>
      <div className={styles["item"] + styles["item--2"]}>
        ...
        <span className={styles["quantity"]}> 70+ </span>
      ...
      <div className={styles["item"] + styles["item--3"]}>
        ...
        <span className={styles["quantity"]}> 150+ </span>
        <span className={styles["text"] + styles["text--3"]}> Components </span>
      </div>
      <div className={styles["item"] + styles["item--4"]}>
        ...
        <span className={styles["quantity"]}> 30+ </span>
        <span className={styles["text"] + styles["text--4"]}> Animations </span>
      </div>
    </div>
  </div>
);

export default Card_death;
{
