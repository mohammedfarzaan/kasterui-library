...
import styles from "./Card_money.module.css";

const Card_money = () => (
  <div>
    <div className={styles["card"]}>
      <span className={styles["small-text"]}>Download Now!</span>
      ...
      <div className={styles["buttons"]}>
        <a href="#" className={styles["button"]}>
          ...
          <div className={styles["button-text"] + styles["google"]}>
            <span>Get it on</span>
        ...
        <a href="#" className={styles["button"]}>
          ...
          <div className={styles["button-text"] + styles["apple"]}>
