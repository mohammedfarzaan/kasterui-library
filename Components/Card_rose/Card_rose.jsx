...
import styles from "./Card_rose.module.css";
    ...
    <div className={styles["main"]}>
      <div className={styles["card"]}>
        <div className={styles["fl"]}>
          <div className={styles["fullscreen"]}>
            <svg viewBox="0 0 100 100" className={styles["fullscreen_svg"]}>
        ...
        <div className={styles["card_content"]}>
          <label className={styles["switch_738"]}>
            <input type="checkbox" className={styles["chk_738"]} />
            <span className={styles["slider_738"]}></span>
          </label>
        </div>
      ...
      <div className={styles["data"]}>
        ...
        <div className={styles["text"]}>
          <div className={styles["text_m"]}>CSS Theme Switch</div>
          <div className={styles["text_s"]}>Praashoo7</div>
        </div>
      </div>
      <div className={styles["btns"]}>
        <div className={styles["likes"]}>
          <svg className={styles["likes_svg"]} viewBox="-2 0 105 92">
