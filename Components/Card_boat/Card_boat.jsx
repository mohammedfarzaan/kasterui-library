...
import styles from "./Card_boat.module.css";
    ...
    <div className={styles["like-dislike-container"]}>
      ...
      <div className={styles["icons-box"]}>
        <div className={styles["icons"]}>
          <label className={styles["btn-label"]} for="like-checkbox">
            <span className={styles["like-text-content"]}>123</span>
            <input
            ...
            <div className={styles["fireworks"]}>
              <div className={styles["checked-like-fx"]}></div>
            </div>
          </label>
        </div>
        <div className={styles["icons"]}>
          <label className={styles["btn-label"]} for="dislike-checkbox">
            <input
              className={styles["input-box"]}
              id="dislike-checkbox"
              type="checkbox"
            />
            <div className={styles["fireworks"]}>
              <div className={styles["checked-dislike-fx"]}></div>
            </div>
            <svg
              className={styles["svgs"]}
            ...
            <span className={styles["dislike-text-content"]}>4</span>
          </label>
        </div>
      </div>
    </div>
