...
import styles from "./Loader_foot.module.css";
          ...
          <g>
            ...
            <g stroke="hsl(193,90%,50%)" fill="none">
              <circle
                ...
                cy="64"
                cx="64"
                className={styles["loader__mouth1"]}
              ></circle>
              <circle
                ...
                cy="64"
                cx="64"
                className={styles["loader__mouth2"]}
              ></circle>
            </g>
          </g>
