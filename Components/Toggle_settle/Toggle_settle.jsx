...
import styles from "./Toggle_settle.module.css";
    ...
    >
      ...
      <g transform="translate(-130 -110)" className="svg-switch">
		...
		C458.001,317.94,450.011,317.94,445.083,313.013z"
          ...
          id="end_container"
        ></path>
        <text y="255" x="225" className="text-label noselect">
          OFF
        </text>
        <text y="255" x="430" className="text-label noselect">
          ON
        </text>
