...
}
{
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="sunshine">
    <path d="M0 0h256v256H0z" fill="none"></path>
    <path className="stroke-000000" d="M128 32v32M195.9 60.1l-22.6 22.6M224 128h-32M195.9 195.9l-22.6-22.6M128 224v-32M60.1 195.9l22.6-22.6M32 128h32M60.1 60.1l22.6 22.6" stroke-width="8" stroke-linejoin="round" stroke-linecap="round" stroke="#fe8a1e" fill="none">
    </path>
  </svg>
