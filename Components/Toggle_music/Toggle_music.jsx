...
import styles from "./Toggle_music.module.css";

const Toggle_music = () => (
  <div>
    <div>
      <input id="checkbox-input" type="checkbox" />
      <label className={styles["switch"]} for="checkbox-input">
        <svg
          xml:space="preserve"
  ...
  /*
        ...
        const Toggle_music = () => (
         <div>
          <div>
  <input id="checkbox-input" type="checkbox" />
  <label className="switch" for="checkbox-input">
    <svg
      xml:space="preserve"
      style="enable-background:new 0 0 128 128"
      viewBox="0 0 128 128"
