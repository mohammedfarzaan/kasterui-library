...
import styles from "./Card_early.module.css";

const Card_early = () => (
  <div>
    <div className={styles["group"]}>
      <div className={styles["card-box"]}>
        <div id="Hegel" className={styles["card"]}>
          ...
          <div className={styles["thumb"]}>
            <svg
              viewBox="0 0 16 16"
              className={styles["bi"] + styles["bi-camera-reels"]}
              fill="currentColor"
              height="16"
              width="16"
          ...
          <div className={styles["detial"]}>
            <div className={styles["title"]}>
              <p className={styles["name"]}>Film</p>
              <div className={styles["action"]}>
                <svg
                  className={styles["mode"] + styles["hide"]}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                  fill="currentColor"
            ...
            <div className={styles["level"]}>
              <svg
                viewBox="0 0 16 16"
                className={styles["bi"] + styles["bi-star-fill"]}
                fill="currentColor"
                height="16"
                width="16"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <svg
                viewBox="0 0 16 16"
                className={styles["bi"] + styles["bi-star"]}
                fill="currentColor"
                height="16"
                width="16"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className={styles["infomation"]}>
              <p className={styles["propertion"]}>2024.1.11</p>
              <p className={styles["propertion"]}>xxx</p>
              <p className={styles["propertion"]}>type</p>
            </div>
          </div>
        </div>
      </div>
