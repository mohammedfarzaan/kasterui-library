...
import styles from "./Input_failed.module.css";
...
const Input_failed = () => (
  <div>
    <div className={styles["InputContainer"]}>
      ...
      <label for="input" className={styles["labelforsearch"]}>
      ...
      <button className={styles["micButton"]}>
        <svg viewBox="0 0 384 512" className={styles["micIcon"]}>
