...
import styles from "./Card_mass.module.css";
  ...
  <div>
    <div className={styles["section_our_solution"]}>
      <div className={styles["row"]}>
        <div
          className={
            styles["col-lg-12"] + styles["col-md-12"] + styles["col-sm-12"]
          }
        >
            ...
            <div className={styles["solution_cards_box"]}>
              <div className={styles["solution_card"]}>
                ...
                <div className={styles["solu_description"]}>
                  ...
                  <button className={styles["read_more_btn"]} type="button">
                    Read More
                  </button>
                </div>
              </div>
